...
THEMES = {
    ...
    "cyber_ocean_light": ThemeDefinition(
        ...
        description="A branded light companion with cool ocean blues, tinted panels, and a sharper cyber identity.",
        background="#EEF6FB",
        panel="#DCECF5",
        surface="#F8FCFF",
        surface_alt="#E6F1F8",
        ...
        accent="#0077B6",
        accent_hover="#00669E",
        accent_pressed="#004F78",
        accent_text="#F8FCFF",
        input_background="#F8FCFF",
        selection="#93D7F2",
        selection_text="#0A2233",
        warning_background="#FFF2D8",
        warning_border="#D28B1D",
        warning_text="#6D4700",
    ),
    "clean_analyst_light": ThemeDefinition(
        name="clean_analyst_light",
        label="Clean Analyst Light",
        description="A neutral, polished dashboard theme with restrained colour and report-friendly contrast.",
        background="#F8FAFC",
        panel="#FFFFFF",
        surface="#F1F5F9",
        surface_alt="#E7EDF3",
    ...
    "executive_report": ThemeDefinition(
        ...
        description="A warmer business-facing light theme designed for screenshots, reports, and executive review.",
        background="#F7F5F2",
        panel="#FFFFFF",
        surface="#F5F2EC",
        surface_alt="#ECE7DE",
    ...
    "muted_mint_analyst": ThemeDefinition(
        ...
        description="A softer mint-forward light theme with calmer green accents and an approachable security feel.",
        background="#F4FBF8",
        panel="#FFFFFF",
        surface="#E8F5F0",
        surface_alt="#DDEDE6",
